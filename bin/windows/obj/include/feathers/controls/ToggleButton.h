...
class HXCPP_CLASS_ATTRIBUTES ToggleButton_obj : public  ::feathers::controls::BasicToggleButton_obj
{
	...
	public:
		...
		virtual  ::Dynamic calculateExplicitWidthForTextMeasurement();
		::Dynamic calculateExplicitWidthForTextMeasurement_dyn();

		virtual Float measureContentWidth();
		::Dynamic measureContentWidth_dyn();

		virtual Float measureContentHeight();
		::Dynamic measureContentHeight_dyn();

		virtual Float measureContentMinWidth();
		::Dynamic measureContentMinWidth_dyn();

		virtual Float measureContentMinHeight();
		...
		virtual void refreshTextFieldDimensions(bool forMeasurement);
