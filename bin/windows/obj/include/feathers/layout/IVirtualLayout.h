...
class HXCPP_CLASS_ATTRIBUTES IVirtualLayout_obj {
	public:
		...
		static inline Float get_scrollX( ::Dynamic _hx_) {
			return (_hx_.mPtr->*( ::hx::interface_cast< ::feathers::layout::IVirtualLayout_obj *>(_hx_.mPtr->_hx_getInterface(0x3aa17e26)))->_hx_get_scrollX)();
		}
		...
		static inline Float get_scrollY( ::Dynamic _hx_) {
			return (_hx_.mPtr->*( ::hx::interface_cast< ::feathers::layout::IVirtualLayout_obj *>(_hx_.mPtr->_hx_getInterface(0x3aa17e26)))->_hx_get_scrollY)();
		}
		...
		static inline bool get_elasticTop( ::Dynamic _hx_) {
			return (_hx_.mPtr->*( ::hx::interface_cast< ::feathers::layout::IVirtualLayout_obj *>(_hx_.mPtr->_hx_getInterface(0x3aa17e26)))->_hx_get_elasticTop)();
		}
		bool (::hx::Object :: *_hx_get_elasticRight)(); 
		static inline bool get_elasticRight( ::Dynamic _hx_) {
			return (_hx_.mPtr->*( ::hx::interface_cast< ::feathers::layout::IVirtualLayout_obj *>(_hx_.mPtr->_hx_getInterface(0x3aa17e26)))->_hx_get_elasticRight)();
		}
		bool (::hx::Object :: *_hx_get_elasticBottom)(); 
		static inline bool get_elasticBottom( ::Dynamic _hx_) {
			return (_hx_.mPtr->*( ::hx::interface_cast< ::feathers::layout::IVirtualLayout_obj *>(_hx_.mPtr->_hx_getInterface(0x3aa17e26)))->_hx_get_elasticBottom)();
		}
		bool (::hx::Object :: *_hx_get_elasticLeft)(); 
		static inline bool get_elasticLeft( ::Dynamic _hx_) {
			return (_hx_.mPtr->*( ::hx::interface_cast< ::feathers::layout::IVirtualLayout_obj *>(_hx_.mPtr->_hx_getInterface(0x3aa17e26)))->_hx_get_elasticLeft)();
		}
		...
		static inline  ::openfl::geom::Point getNearestScrollPositionForIndex( ::Dynamic _hx_,int index,int itemCount,Float width,Float height, ::openfl::geom::Point result) {
			return (_hx_.mPtr->*( ::hx::interface_cast< ::feathers::layout::IVirtualLayout_obj *>(_hx_.mPtr->_hx_getInterface(0x3aa17e26)))->_hx_getNearestScrollPositionForIndex)(index,itemCount,width,height,result);
		}
