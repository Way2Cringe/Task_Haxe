...
class HXCPP_CLASS_ATTRIBUTES UnderlineSkin_obj : public  ::feathers::skins::BaseGraphicsPathSkin_obj
{
	...
	public:
		...
		static ::hx::ObjectPtr< UnderlineSkin_obj > __new( ::feathers::graphics::FillStyle fill, ::feathers::graphics::LineStyle border);
		static ::hx::ObjectPtr< UnderlineSkin_obj > __alloc(::hx::Ctx *_hx_ctx, ::feathers::graphics::FillStyle fill, ::feathers::graphics::LineStyle border);
