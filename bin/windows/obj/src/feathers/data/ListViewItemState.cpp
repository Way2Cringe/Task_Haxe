...
HX_DEFINE_STACK_FRAME(_hx_pos_28e4ed3fb4438c9e_21_new,"feathers.data.ListViewItemState","new",0x3223d567,"feathers.data.ListViewItemState.new","feathers/data/ListViewItemState.hx",21,0x58a9e049)
namespace feathers{
namespace data{
...
::hx::Val ListViewItemState_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"owner") ) { owner=inValue.Cast<  ::feathers::controls::ListView >(); return inValue; }
...
static ::hx::StorageInfo ListViewItemState_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::feathers::controls::ListView */ ,(int)offsetof(ListViewItemState_obj,owner),HX_("owner",33,98,76,38)},
	...
	{::hx::fsBool,(int)offsetof(ListViewItemState_obj,enabled),HX_("enabled",81,04,31,7e)},
	{::hx::fsString,(int)offsetof(ListViewItemState_obj,recyclerID),HX_("recyclerID",9a,be,43,a8)},
	{ ::hx::fsUnknown, 0, null()}
};
