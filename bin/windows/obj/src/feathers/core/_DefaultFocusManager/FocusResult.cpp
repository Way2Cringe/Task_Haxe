...
HX_DEFINE_STACK_FRAME(_hx_pos_fe42c7cb193c7f49_1022_new,"feathers.core._DefaultFocusManager.FocusResult","new",0xc105a6e1,"feathers.core._DefaultFocusManager.FocusResult.new","feathers/core/DefaultFocusManager.hx",1022,0x2c1b51d9)
namespace feathers{
namespace core{
namespace _DefaultFocusManager{

void FocusResult_obj::__construct(::Dynamic newFocus,bool wrapped){
            	HX_STACKFRAME(&_hx_pos_fe42c7cb193c7f49_1022_new)
HXLINE(1023)		this->newFocus = newFocus;
HXLINE(1024)		this->wrapped = wrapped;
            	}
