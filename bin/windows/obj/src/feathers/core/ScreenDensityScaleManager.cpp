...
HX_LOCAL_STACK_FRAME(_hx_pos_46c206bc133d7389_99_get_target,"feathers.core.ScreenDensityScaleManager","get_target",0x50eb66ba,"feathers.core.ScreenDensityScaleManager.get_target","feathers/core/ScreenDensityScaleManager.hx",99,0xf525eb10)
HX_LOCAL_STACK_FRAME(_hx_pos_46c206bc133d7389_102_set_target,"feathers.core.ScreenDensityScaleManager","set_target",0x5469052e,"feathers.core.ScreenDensityScaleManager.set_target","feathers/core/ScreenDensityScaleManager.hx",102,0xf525eb10)
HX_LOCAL_STACK_FRAME(_hx_pos_46c206bc133d7389_132_get_scaler,"feathers.core.ScreenDensityScaleManager","get_scaler",0x06245e11,"feathers.core.ScreenDensityScaleManager.get_scaler","feathers/core/ScreenDensityScaleManager.hx",132,0xf525eb10)
HX_LOCAL_STACK_FRAME(_hx_pos_46c206bc133d7389_135_set_scaler,"feathers.core.ScreenDensityScaleManager","set_scaler",0x09a1fc85,"feathers.core.ScreenDensityScaleManager.set_scaler","feathers/core/ScreenDensityScaleManager.hx",135,0xf525eb10)
HX_LOCAL_STACK_FRAME(_hx_pos_46c206bc133d7389_147_getScale,"feathers.core.ScreenDensityScaleManager","getScale",0xb776b9b4,"feathers.core.ScreenDensityScaleManager.getScale","feathers/core/ScreenDensityScaleManager.hx",147,0xf525eb10)
HX_LOCAL_STACK_FRAME(_hx_pos_46c206bc133d7389_194_getBounds,"feathers.core.ScreenDensityScaleManager","getBounds",0xfa63600b,"feathers.core.ScreenDensityScaleManager.getBounds","feathers/core/ScreenDensityScaleManager.hx",194,0xf525eb10)
HX_LOCAL_STACK_FRAME(_hx_pos_46c206bc133d7389_217_addTargetStageListeners,"feathers.core.ScreenDensityScaleManager","addTargetStageListeners",0x100ab333,"feathers.core.ScreenDensityScaleManager.addTargetStageListeners","feathers/core/ScreenDensityScaleManager.hx",217,0xf525eb10)
HX_LOCAL_STACK_FRAME(_hx_pos_46c206bc133d7389_224_removeTargetStageListeners,"feathers.core.ScreenDensityScaleManager","removeTargetStageListeners",0xb2a26c16,"feathers.core.ScreenDensityScaleManager.removeTargetStageListeners","feathers/core/ScreenDensityScaleManager.hx",224,0xf525eb10)
HX_LOCAL_STACK_FRAME(_hx_pos_46c206bc133d7389_232_screenDensityScaleManager_target_addedToStageHandler,"feathers.core.ScreenDensityScaleManager","screenDensityScaleManager_target_addedToStageHandler",0xbdb3d299,"feathers.core.ScreenDensityScaleManager.screenDensityScaleManager_target_addedToStageHandler","feathers/core/ScreenDensityScaleManager.hx",232,0xf525eb10)
HX_LOCAL_STACK_FRAME(_hx_pos_46c206bc133d7389_236_screenDensityScaleManager_target_removedFromStageHandler,"feathers.core.ScreenDensityScaleManager","screenDensityScaleManager_target_removedFromStageHandler",0x495b20e8,"feathers.core.ScreenDensityScaleManager.screenDensityScaleManager_target_removedFromStageHandler","feathers/core/ScreenDensityScaleManager.hx",236,0xf525eb10)
HX_LOCAL_STACK_FRAME(_hx_pos_46c206bc133d7389_240_screenDensityScaleManager_stage_resizeHandler,"feathers.core.ScreenDensityScaleManager","screenDensityScaleManager_stage_resizeHandler",0x89530995,"feathers.core.ScreenDensityScaleManager.screenDensityScaleManager_stage_resizeHandler","feathers/core/ScreenDensityScaleManager.hx",240,0xf525eb10)
namespace feathers{
namespace core{
...
void *ScreenDensityScaleManager_obj::_hx_getInterface(int inHash) {
 ...
 ::openfl::display::DisplayObject ScreenDensityScaleManager_obj::get_target(){
            	HX_STACKFRAME(&_hx_pos_46c206bc133d7389_99_get_target)
HXDLIN(  99)		return this->_target;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ScreenDensityScaleManager_obj,get_target,return )
 ...
 ::openfl::display::DisplayObject ScreenDensityScaleManager_obj::set_target( ::openfl::display::DisplayObject value){
            	HX_STACKFRAME(&_hx_pos_46c206bc133d7389_102_set_target)
HXLINE( 103)		if (::hx::IsInstanceEq( this->_target,value )) {
HXLINE( 104)			return this->_target;
            		}
HXLINE( 106)		if (::hx::IsNotNull( this->_target )) {
HXLINE( 107)			this->removeTargetStageListeners();
HXLINE( 108)			this->_target->removeEventListener(HX_("addedToStage",63,22,55,0c),this->screenDensityScaleManager_target_addedToStageHandler_dyn(),null());
HXLINE( 109)			this->_target->removeEventListener(HX_("removedFromStage",34,21,76,ba),this->screenDensityScaleManager_target_removedFromStageHandler_dyn(),null());
            		}
HXLINE( 111)		this->_target = value;
HXLINE( 112)		if (::hx::IsNotNull( this->_target )) {
HXLINE( 113)			this->_target->addEventListener(HX_("addedToStage",63,22,55,0c),this->screenDensityScaleManager_target_addedToStageHandler_dyn(),false,0,true);
HXLINE( 114)			this->_target->addEventListener(HX_("removedFromStage",34,21,76,ba),this->screenDensityScaleManager_target_removedFromStageHandler_dyn(),false,0,true);
HXLINE( 115)			this->addTargetStageListeners();
            		}
HXLINE( 117)		::feathers::events::FeathersEvent_obj::dispatch(::hx::ObjectPtr<OBJ_>(this),HX_("change",70,91,72,b7),null(),null());
HXLINE( 118)		return this->_target;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ScreenDensityScaleManager_obj,set_target,return )
 ...
 ::feathers::utils::ScreenDensityScaleCalculator ScreenDensityScaleManager_obj::get_scaler(){
            	HX_STACKFRAME(&_hx_pos_46c206bc133d7389_132_get_scaler)
HXDLIN( 132)		return this->_scaler;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ScreenDensityScaleManager_obj,get_scaler,return )
 ...
 ::feathers::utils::ScreenDensityScaleCalculator ScreenDensityScaleManager_obj::set_scaler( ::feathers::utils::ScreenDensityScaleCalculator value){
            	HX_STACKFRAME(&_hx_pos_46c206bc133d7389_135_set_scaler)
HXLINE( 136)		if (::hx::IsInstanceEq( this->_scaler,value )) {
HXLINE( 137)			return this->_scaler;
            		}
HXLINE( 139)		this->_scaler = value;
HXLINE( 140)		::feathers::events::FeathersEvent_obj::dispatch(::hx::ObjectPtr<OBJ_>(this),HX_("change",70,91,72,b7),null(),null());
HXLINE( 141)		return this->_scaler;
            	}
...
Float ScreenDensityScaleManager_obj::getScale(){
            	HX_STACKFRAME(&_hx_pos_46c206bc133d7389_147_getScale)
HXLINE( 148)		Float result = ((Float)1.0);
HXLINE( 149)		if (::hx::IsNull( this->_target )) {
...
HX_DEFINE_DYNAMIC_FUNC0(ScreenDensityScaleManager_obj,getScale,return )
 ...
 ::openfl::geom::Rectangle ScreenDensityScaleManager_obj::getBounds(){
            	HX_GC_STACKFRAME(&_hx_pos_46c206bc133d7389_194_getBounds)
HXLINE( 195)		 ::openfl::geom::Rectangle bounds =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
HXLINE( 196)		if (::hx::IsNull( this->_target )) {
HXLINE( 197)			return bounds;
            		}
HXLINE( 199)		 ::openfl::display::Stage stage = this->_target->stage;
HXLINE( 200)		if (::hx::IsNull( stage )) {
HXLINE( 201)			return bounds;
            		}
HXLINE( 203)		Float needsToBeDivisibleByTwo = ::Math_obj::ffloor(this->_target->get_scaleX());
HXDLIN( 203)		bool needsToBeDivisibleByTwo1 = (needsToBeDivisibleByTwo != this->_target->get_scaleX());
HXLINE( 204)		Float appWidth = ::Math_obj::ffloor(( (Float)(stage->stageWidth) ));
HXLINE( 205)		if (needsToBeDivisibleByTwo1) {
HXLINE( 206)			appWidth = ::feathers::utils::MathUtil_obj::roundDownToNearest(appWidth,2);
            		}
HXLINE( 208)		bounds->width = appWidth;
HXLINE( 209)		Float appHeight = ::Math_obj::ffloor(( (Float)(stage->stageHeight) ));
HXLINE( 210)		if (needsToBeDivisibleByTwo1) {
HXLINE( 211)			appHeight = ::feathers::utils::MathUtil_obj::roundDownToNearest(appHeight,2);
            		}
HXLINE( 213)		bounds->height = appHeight;
HXLINE( 214)		return bounds;
            	}
...
void ScreenDensityScaleManager_obj::addTargetStageListeners(){
            	HX_STACKFRAME(&_hx_pos_46c206bc133d7389_217_addTargetStageListeners)
HXLINE( 218)		bool _hx_tmp;
HXDLIN( 218)		if (::hx::IsNotNull( this->_target )) {
HXLINE( 218)			_hx_tmp = ::hx::IsNull( this->_target->stage );
            		}
            		else {
...
HXLINE( 221)		this->_target->stage->addEventListener(HX_("resize",f4,59,7b,08),this->screenDensityScaleManager_stage_resizeHandler_dyn(),false,0,true);
            	}
...
void ScreenDensityScaleManager_obj::removeTargetStageListeners(){
            	HX_STACKFRAME(&_hx_pos_46c206bc133d7389_224_removeTargetStageListeners)
HXLINE( 225)		bool _hx_tmp;
HXDLIN( 225)		if (::hx::IsNotNull( this->_target )) {
HXLINE( 225)			_hx_tmp = ::hx::IsNull( this->_target->stage );
            		}
            		else {
...
HXLINE( 228)		this->_target->stage->removeEventListener(HX_("resize",f4,59,7b,08),this->screenDensityScaleManager_stage_resizeHandler_dyn(),null());
            	}
...
void ScreenDensityScaleManager_obj::screenDensityScaleManager_target_addedToStageHandler( ::openfl::events::Event event){
            	HX_STACKFRAME(&_hx_pos_46c206bc133d7389_232_screenDensityScaleManager_target_addedToStageHandler)
HXDLIN( 232)		this->addTargetStageListeners();
            	}
...
void ScreenDensityScaleManager_obj::screenDensityScaleManager_target_removedFromStageHandler( ::openfl::events::Event event){
            	HX_STACKFRAME(&_hx_pos_46c206bc133d7389_236_screenDensityScaleManager_target_removedFromStageHandler)
HXDLIN( 236)		this->removeTargetStageListeners();
            	}
...
void ScreenDensityScaleManager_obj::screenDensityScaleManager_stage_resizeHandler( ::openfl::events::Event event){
            	HX_STACKFRAME(&_hx_pos_46c206bc133d7389_240_screenDensityScaleManager_stage_resizeHandler)
HXDLIN( 240)		::feathers::events::FeathersEvent_obj::dispatch(::hx::ObjectPtr<OBJ_>(this),HX_("change",70,91,72,b7),null(),null());
            	}
