...
HX_DEFINE_STACK_FRAME(_hx_pos_c30f7d542045fc82_972_new,"feathers.controls._ButtonBar.ButtonStorage","new",0xe17c82e9,"feathers.controls._ButtonBar.ButtonStorage.new","feathers/controls/ButtonBar.hx",972,0x8cf93d57)
namespace feathers{
namespace controls{
namespace _ButtonBar{

void ButtonStorage_obj::__construct(::String id, ::feathers::utils::DisplayObjectRecycler recycler){
            	HX_STACKFRAME(&_hx_pos_c30f7d542045fc82_972_new)
HXLINE( 982)		this->inactiveButtons = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 981)		this->activeButtons = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 974)		this->id = id;
HXLINE( 975)		this->buttonRecycler = recycler;
            	}
