...
HX_DEFINE_STACK_FRAME(_hx_pos_601449c36b95fe07_1241_new,"feathers.controls._TabBar.TabStorage","new",0x760a9203,"feathers.controls._TabBar.TabStorage.new","feathers/controls/TabBar.hx",1241,0xc18603c6)
namespace feathers{
namespace controls{
namespace _TabBar{

void TabStorage_obj::__construct(::String id, ::feathers::utils::DisplayObjectRecycler recycler){
            	HX_STACKFRAME(&_hx_pos_601449c36b95fe07_1241_new)
HXLINE(1251)		this->inactiveTabs = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1250)		this->activeTabs = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1243)		this->id = id;
HXLINE(1244)		this->tabRecycler = recycler;
            	}
