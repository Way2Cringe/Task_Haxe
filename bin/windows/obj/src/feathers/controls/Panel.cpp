...
HX_LOCAL_STACK_FRAME(_hx_pos_e987dd0021e4ab29_158_update,"feathers.controls.Panel","update",0x9944f14d,"feathers.controls.Panel.update","feathers/controls/Panel.hx",158,0x00a52c34)
HX_LOCAL_STACK_FRAME(_hx_pos_e987dd0021e4ab29_176_calculateViewPortOffsets,"feathers.controls.Panel","calculateViewPortOffsets",0x834f7718,"feathers.controls.Panel.calculateViewPortOffsets","feathers/controls/Panel.hx",176,0x00a52c34)
HX_LOCAL_STACK_FRAME(_hx_pos_e987dd0021e4ab29_214_layoutHeader,"feathers.controls.Panel","layoutHeader",0x6819be1b,"feathers.controls.Panel.layoutHeader","feathers/controls/Panel.hx",214,0x00a52c34)
HX_LOCAL_STACK_FRAME(_hx_pos_e987dd0021e4ab29_226_layoutFooter,"feathers.controls.Panel","layoutFooter",0x66b1f329,"feathers.controls.Panel.layoutFooter","feathers/controls/Panel.hx",226,0x00a52c34)
HX_LOCAL_STACK_FRAME(_hx_pos_e987dd0021e4ab29_238_panel_header_resizeHandler,"feathers.controls.Panel","panel_header_resizeHandler",0x04701863,"feathers.controls.Panel.panel_header_resizeHandler","feathers/controls/Panel.hx",238,0x00a52c34)
HX_LOCAL_STACK_FRAME(_hx_pos_e987dd0021e4ab29_250_panel_footer_resizeHandler,"feathers.controls.Panel","panel_footer_resizeHandler",0x9addc9f1,"feathers.controls.Panel.panel_footer_resizeHandler","feathers/controls/Panel.hx",250,0x00a52c34)
...
void Panel_obj::update(){
            	HX_STACKFRAME(&_hx_pos_e987dd0021e4ab29_158_update)
HXLINE( 161)		this->_ignoreChangesButSetFlags = false;
HXLINE( 163)		this->super::update();
HXLINE( 165)		bool oldIgnoreHeaderResize = this->_ignoreHeaderResize;
HXLINE( 166)		this->_ignoreHeaderResize = true;
HXLINE( 167)		this->layoutHeader();
HXLINE( 168)		this->_ignoreHeaderResize = oldIgnoreHeaderResize;
HXLINE( 170)		bool oldIgnoreFooterResize = this->_ignoreFooterResize;
HXLINE( 171)		this->_ignoreFooterResize = true;
HXLINE( 172)		this->layoutFooter();
HXLINE( 173)		this->_ignoreFooterResize = oldIgnoreFooterResize;
            	}


void Panel_obj::calculateViewPortOffsets(bool forceScrollBars,bool useActualBounds){
            	HX_STACKFRAME(&_hx_pos_e987dd0021e4ab29_176_calculateViewPortOffsets)
HXLINE( 177)		if (::hx::IsNotNull( this->_header )) {
HXLINE( 178)			bool oldIgnoreHeaderResize = this->_ignoreHeaderResize;
HXLINE( 179)			this->_ignoreHeaderResize = true;
HXLINE( 180)			if (::hx::IsNotNull( this->_headerMeasurements )) {
HXLINE( 181)				this->_headerMeasurements->restore(this->_header);
            			}
HXLINE( 183)			if (::Std_obj::isOfType(this->_header,::hx::ClassOf< ::feathers::core::IValidating >())) {
HXLINE( 184)				::feathers::core::IValidating_obj::validateNow( ::hx::interface_check(this->_header,0x64d4b3cd));
            			}
HXLINE( 186)			 ::feathers::controls::Panel _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 186)			Float _hx_tmp1 = _hx_tmp->topViewPortOffset;
HXDLIN( 186)			_hx_tmp->topViewPortOffset = (_hx_tmp1 + this->_header->get_height());
HXLINE( 187)			Float _hx_tmp2 = this->chromeMeasuredWidth;
HXDLIN( 187)			this->chromeMeasuredWidth = ::Math_obj::max(_hx_tmp2,this->_header->get_width());
HXLINE( 188)			if (::Std_obj::isOfType(this->_header,::hx::ClassOf< ::feathers::core::IMeasureObject >())) {
HXLINE( 189)				::Dynamic measureHeader =  ::hx::interface_check(this->_header,0xcfc32883);
HXLINE( 190)				Float _hx_tmp3 = this->chromeMeasuredMinWidth;
HXDLIN( 190)				this->chromeMeasuredMinWidth = ::Math_obj::max(_hx_tmp3,::feathers::core::IMeasureObject_obj::get_minWidth(measureHeader));
            			}
HXLINE( 192)			this->_ignoreHeaderResize = oldIgnoreHeaderResize;
            		}
HXLINE( 194)		if (::hx::IsNotNull( this->_footer )) {
HXLINE( 195)			bool oldIgnoreFooterResize = this->_ignoreFooterResize;
HXLINE( 196)			this->_ignoreFooterResize = true;
HXLINE( 197)			if (::hx::IsNotNull( this->_footerMeasurements )) {
HXLINE( 198)				this->_footerMeasurements->restore(this->_footer);
            			}
HXLINE( 200)			if (::Std_obj::isOfType(this->_footer,::hx::ClassOf< ::feathers::core::IValidating >())) {
HXLINE( 201)				::feathers::core::IValidating_obj::validateNow( ::hx::interface_check(this->_footer,0x64d4b3cd));
            			}
HXLINE( 203)			 ::feathers::controls::Panel _hx_tmp4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 203)			Float _hx_tmp5 = _hx_tmp4->bottomViewPortOffset;
HXDLIN( 203)			_hx_tmp4->bottomViewPortOffset = (_hx_tmp5 + this->_footer->get_height());
HXLINE( 204)			Float _hx_tmp6 = this->chromeMeasuredWidth;
HXDLIN( 204)			this->chromeMeasuredWidth = ::Math_obj::max(_hx_tmp6,this->_footer->get_width());
HXLINE( 205)			if (::Std_obj::isOfType(this->_footer,::hx::ClassOf< ::feathers::core::IMeasureObject >())) {
HXLINE( 206)				::Dynamic measureFooter =  ::hx::interface_check(this->_footer,0xcfc32883);
HXLINE( 207)				Float _hx_tmp7 = this->chromeMeasuredMinWidth;
HXDLIN( 207)				this->chromeMeasuredMinWidth = ::Math_obj::max(_hx_tmp7,::feathers::core::IMeasureObject_obj::get_minWidth(measureFooter));
            			}
HXLINE( 209)			this->_ignoreFooterResize = oldIgnoreFooterResize;
            		}
HXLINE( 211)		this->super::calculateViewPortOffsets(forceScrollBars,useActualBounds);
            	}


void Panel_obj::layoutHeader(){
            	HX_STACKFRAME(&_hx_pos_e987dd0021e4ab29_214_layoutHeader)
HXLINE( 215)		if (::hx::IsNull( this->_header )) {
HXLINE( 216)			return;
            		}
HXLINE( 218)		 ::openfl::display::DisplayObject _hx_tmp = this->_header;
HXDLIN( 218)		_hx_tmp->set_x(this->get_paddingLeft());
HXLINE( 219)		 ::openfl::display::DisplayObject _hx_tmp1 = this->_header;
HXDLIN( 219)		_hx_tmp1->set_y(this->get_paddingTop());
HXLINE( 220)		 ::openfl::display::DisplayObject _hx_tmp2 = this->_header;
HXDLIN( 220)		Float _hx_tmp3 = this->actualWidth;
HXDLIN( 220)		Float _hx_tmp4 = (_hx_tmp3 - this->get_paddingLeft());
HXDLIN( 220)		_hx_tmp2->set_width((_hx_tmp4 - this->get_paddingRight()));
HXLINE( 221)		if (::Std_obj::isOfType(this->_header,::hx::ClassOf< ::feathers::core::IValidating >())) {
HXLINE( 222)			::feathers::core::IValidating_obj::validateNow( ::hx::interface_check(this->_header,0x64d4b3cd));
            		}
            	}
...
void Panel_obj::layoutFooter(){
            	HX_STACKFRAME(&_hx_pos_e987dd0021e4ab29_226_layoutFooter)
HXLINE( 227)		if (::hx::IsNull( this->_footer )) {
HXLINE( 228)			return;
            		}
HXLINE( 230)		 ::openfl::display::DisplayObject _hx_tmp = this->_footer;
HXDLIN( 230)		_hx_tmp->set_x(this->get_paddingLeft());
HXLINE( 231)		 ::openfl::display::DisplayObject _hx_tmp1 = this->_footer;
HXDLIN( 231)		Float _hx_tmp2 = this->actualWidth;
HXDLIN( 231)		Float _hx_tmp3 = (_hx_tmp2 - this->get_paddingLeft());
HXDLIN( 231)		_hx_tmp1->set_width((_hx_tmp3 - this->get_paddingRight()));
HXLINE( 232)		if (::Std_obj::isOfType(this->_footer,::hx::ClassOf< ::feathers::core::IValidating >())) {
HXLINE( 233)			::feathers::core::IValidating_obj::validateNow( ::hx::interface_check(this->_footer,0x64d4b3cd));
            		}
HXLINE( 235)		 ::openfl::display::DisplayObject _hx_tmp4 = this->_footer;
HXDLIN( 235)		Float _hx_tmp5 = this->actualHeight;
HXDLIN( 235)		Float _hx_tmp6 = (_hx_tmp5 - this->_footer->get_height());
HXDLIN( 235)		_hx_tmp4->set_y((_hx_tmp6 - this->get_paddingBottom()));
            	}
...
void Panel_obj::panel_header_resizeHandler( ::openfl::events::Event event){
            	HX_STACKFRAME(&_hx_pos_e987dd0021e4ab29_238_panel_header_resizeHandler)
HXLINE( 239)		if (this->_ignoreHeaderResize) {
HXLINE( 240)			return;
            		}
HXLINE( 242)		if (::hx::IsNotNull( this->_headerMeasurements )) {
HXLINE( 245)			this->_headerMeasurements->save(this->_header);
            		}
HXLINE( 247)		this->setInvalid(::feathers::core::InvalidationFlag_obj::SIZE_dyn());
            	}
...
void Panel_obj::panel_footer_resizeHandler( ::openfl::events::Event event){
            	HX_STACKFRAME(&_hx_pos_e987dd0021e4ab29_250_panel_footer_resizeHandler)
HXLINE( 251)		if (this->_ignoreFooterResize) {
HXLINE( 252)			return;
            		}
HXLINE( 254)		if (::hx::IsNotNull( this->_footerMeasurements )) {
HXLINE( 257)			this->_footerMeasurements->save(this->_footer);
            		}
HXLINE( 259)		this->setInvalid(::feathers::core::InvalidationFlag_obj::SIZE_dyn());
            	}
