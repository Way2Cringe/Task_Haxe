...
void UnderlineSkin_obj::__construct( ::feathers::graphics::FillStyle fill, ::feathers::graphics::LineStyle border){
            	HX_STACKFRAME(&_hx_pos_069e278267f3094f_26_new)
HXDLIN(  26)		super::__construct(fill,border);
            	}
...
bool UnderlineSkin_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x1a956aa3) {
		if (inClassId<=(int)0x093ab78b) {
			...
			return inClassId==(int)0x0c89e854 || inClassId==(int)0x1a956aa3;
		}
	} else {
...
HXDLIN(  36)			_hx_tmp->drawRect(((Float)0.0),((Float)0.0),this->actualWidth,::Math_obj::max(((Float)0.0),(this->actualHeight - thicknessOffset)));
HXLINE(  37)			this->get_graphics()->endFill();
            		}
HXLINE(  40)		Float minLineX = ::Math_obj::min(this->actualWidth,thicknessOffset);
HXLINE(  41)		Float minLineY = ::Math_obj::min(this->actualHeight,thicknessOffset);
HXLINE(  42)		Float maxLineX = ::Math_obj::max(minLineX,(this->actualWidth - thicknessOffset));
HXLINE(  43)		Float maxLineY = ::Math_obj::max(minLineY,(this->actualHeight - thicknessOffset));
HXLINE(  45)		this->applyLineStyle(currentBorder);
HXLINE(  46)		this->get_graphics()->moveTo(minLineX,maxLineY);
HXLINE(  47)		this->get_graphics()->lineTo(maxLineX,maxLineY);
            	}



::hx::ObjectPtr< UnderlineSkin_obj > UnderlineSkin_obj::__new( ::feathers::graphics::FillStyle fill, ::feathers::graphics::LineStyle border) {
	::hx::ObjectPtr< UnderlineSkin_obj > __this = new UnderlineSkin_obj();
	__this->__construct(fill,border);
	return __this;
}

::hx::ObjectPtr< UnderlineSkin_obj > UnderlineSkin_obj::__alloc(::hx::Ctx *_hx_ctx, ::feathers::graphics::FillStyle fill, ::feathers::graphics::LineStyle border) {
