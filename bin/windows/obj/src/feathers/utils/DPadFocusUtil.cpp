...
HXLINE(  72)					_hx_tmp1 = (minPrimaryDistance1 < maxPrimaryDistance2);
            				}
            				else {
...
HXLINE(  89)						_hx_tmp2 = (minPrimaryDistance2 < maxPrimaryDistance1);
            					}
            					else {
...
HXLINE( 124)					Float _hx_tmp3 = globalRect1->get_right();
HXDLIN( 124)					_hx_tmp2 = (_hx_tmp3 <= globalRect2->x);
            				}
            				else {
HXLINE( 124)					_hx_tmp2 = true;
            				}
HXDLIN( 124)				if (_hx_tmp2) {
HXLINE( 125)					Float result2 = globalRect2->get_right();
HXDLIN( 125)					Float result3 = (result2 - globalRect1->x);
HXLINE( 126)					if ((result3 > ((Float)0.0))) {
HXLINE( 127)						return result3;
            					}
            				}
            			}
            			break;
...
HXLINE( 131)					Float _hx_tmp5 = globalRect1->get_bottom();
HXDLIN( 131)					_hx_tmp4 = (_hx_tmp5 <= globalRect2->y);
            				}
            				else {
HXLINE( 131)					_hx_tmp4 = true;
            				}
HXDLIN( 131)				if (_hx_tmp4) {
HXLINE( 132)					Float result4 = globalRect2->get_bottom();
HXDLIN( 132)					Float result5 = (result4 - globalRect1->y);
HXLINE( 133)					if ((result5 > ((Float)0.0))) {
HXLINE( 134)						return result5;
            					}
            				}
            			}
            			break;
...
HXDLIN( 138)				Float _hx_tmp7 = globalRect1->get_right();
HXDLIN( 138)				if (!((_hx_tmp7 > globalRect2->get_right()))) {
HXLINE( 138)					Float globalRect12 = globalRect1->x;
HXDLIN( 138)					_hx_tmp6 = (globalRect12 >= globalRect2->get_right());
            				}
            				else {
HXLINE( 138)					_hx_tmp6 = true;
            				}
HXDLIN( 138)				if (_hx_tmp6) {
HXLINE( 139)					Float result6 = globalRect1->get_right();
HXDLIN( 139)					Float result7 = (result6 - globalRect2->x);
HXLINE( 140)					if ((result7 > ((Float)0.0))) {
HXLINE( 141)						return result7;
            					}
            				}
            			}
            			break;
...
HXLINE( 159)					Float _hx_tmp3 = globalRect1->get_right();
HXDLIN( 159)					_hx_tmp2 = (_hx_tmp3 <= globalRect2->x);
            				}
            				else {
HXLINE( 159)					_hx_tmp2 = true;
            				}
HXDLIN( 159)				if (_hx_tmp2) {
HXLINE( 160)					Float result2 = (globalRect2->x - globalRect1->x);
HXLINE( 161)					if ((result2 > ((Float)0.0))) {
HXLINE( 162)						return result2;
            					}
            				}
            			}
            			break;
...
HXLINE( 166)					Float _hx_tmp5 = globalRect1->get_bottom();
HXDLIN( 166)					_hx_tmp4 = (_hx_tmp5 <= globalRect2->y);
            				}
            				else {
HXLINE( 166)					_hx_tmp4 = true;
            				}
HXDLIN( 166)				if (_hx_tmp4) {
HXLINE( 167)					Float result3 = (globalRect2->y - globalRect1->y);
HXLINE( 168)					if ((result3 > ((Float)0.0))) {
HXLINE( 169)						return result3;
            					}
            				}
            			}
            			break;
            			case (int)3: {
HXLINE( 173)				bool _hx_tmp6;
HXDLIN( 173)				Float _hx_tmp7 = globalRect1->get_right();
HXDLIN( 173)				if (!((_hx_tmp7 > globalRect2->get_right()))) {
HXLINE( 173)					Float globalRect12 = globalRect1->x;
HXDLIN( 173)					_hx_tmp6 = (globalRect12 >= globalRect2->get_right());
            				}
            				else {
HXLINE( 173)					_hx_tmp6 = true;
            				}
HXDLIN( 173)				if (_hx_tmp6) {
HXLINE( 174)					Float result4 = globalRect1->get_right();
HXDLIN( 174)					Float result5 = (result4 - globalRect2->get_right());
HXLINE( 175)					if ((result5 > ((Float)0.0))) {
HXLINE( 176)						return result5;
            					}
            				}
            			}
            			break;
...
HXLINE( 189)		Float globalRect12 = globalRect1->y;
HXDLIN( 189)		if ((globalRect12 <= globalRect2->get_bottom())) {
HXLINE( 189)			Float globalRect22 = globalRect2->y;
HXDLIN( 189)			return (globalRect22 <= globalRect1->get_bottom());
            		}
            		else {
