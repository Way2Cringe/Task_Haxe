...
HXLINE(  50)				{
HXLINE(  50)					int _g2 = 0;
HXDLIN(  50)					int _g3 = otherContainer->get_numChildren();
HXDLIN(  50)					while((_g2 < _g3)){
HXLINE(  50)						_g2 = (_g2 + 1);
HXDLIN(  50)						int i1 = (_g2 - 1);
HXLINE(  51)						 ::openfl::display::DisplayObject childOfTarget1 = otherContainer->getChildAt(i1);
HXLINE(  52)						::feathers::utils::FocusUtil_obj::findAllFocusableObjects(childOfTarget1,result);
            					}
            				}
            			}
            		}
...
HXLINE(  56)				 ::openfl::display::DisplayObjectContainer otherContainer1 = ::hx::TCast<  ::openfl::display::DisplayObjectContainer >::cast(target);
HXLINE(  57)				{
HXLINE(  57)					int _g4 = 0;
HXDLIN(  57)					int _g5 = otherContainer1->get_numChildren();
HXDLIN(  57)					while((_g4 < _g5)){
HXLINE(  57)						_g4 = (_g4 + 1);
HXDLIN(  57)						int i2 = (_g4 - 1);
HXLINE(  58)						 ::openfl::display::DisplayObject childOfTarget2 = otherContainer1->getChildAt(i2);
HXLINE(  59)						::feathers::utils::FocusUtil_obj::findAllFocusableObjects(childOfTarget2,result);
            					}
            				}
            			}
            		}
HXLINE(  62)		if (::Std_obj::isOfType(target,::hx::ClassOf< ::feathers::core::IFocusExtras >())) {
HXLINE(  63)			::Dynamic focusExtras1 =  ::hx::interface_check(target,0x21fbac21);
HXLINE(  64)			::Array< ::Dynamic> extras1 = ::feathers::core::IFocusExtras_obj::get_focusExtrasAfter(focusExtras1);
HXLINE(  65)			if (::hx::IsNotNull( extras1 )) {
HXLINE(  66)				int _g6 = 0;
HXDLIN(  66)				int _g7 = extras1->length;
HXDLIN(  66)				while((_g6 < _g7)){
HXLINE(  66)					_g6 = (_g6 + 1);
HXDLIN(  66)					int i3 = (_g6 - 1);
HXLINE(  67)					 ::openfl::display::DisplayObject childOfTarget3 = extras1->__get(i3).StaticCast<  ::openfl::display::DisplayObject >();
HXLINE(  68)					::feathers::utils::FocusUtil_obj::findAllFocusableObjects(childOfTarget3,result);
            				}
            			}
            		}
