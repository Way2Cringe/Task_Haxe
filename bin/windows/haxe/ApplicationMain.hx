...
class ApplicationMain
{
	...
	public static function main()
	{
		...
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("MyApplication", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["name"] = "Task_Haxe";
		app.meta["packageName"] = "com.example.Task_Haxe";
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("Task_Haxe")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess Task_Haxe.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"Task_Haxe\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"Task_Haxe\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends Task_Haxe {}
#else
class DocumentClass
{
